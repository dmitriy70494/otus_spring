...
public class LocalizedIOServiceImpl implements LocalizedIOService {
    ...
    public LocalizedIOServiceImpl(@Qualifier("consoleIOService") IOService ioService, @Qualifier("localizedMessagesService") LocalizedMessagesService localizedMessagesService) {
    ...
    public int readIntForRangeWithPromptLocalized(int min, int max, String promptCode, String errorMessageCode) {
        return ioService.readIntForRangeWithPrompt(min, max, localizedMessagesService.getMessage(promptCode), localizedMessagesService.getMessage(errorMessageCode));
    }

    @Override
    public String getMessage(String code, Object... args) {
        return code == null ? "" : localizedMessagesService.getMessage(code);
    }
}
